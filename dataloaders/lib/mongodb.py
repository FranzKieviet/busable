...
def upload_data(data, collection_name: str):
    ...
    # 1. Pull connection info from environment variable.
    default_atlas_uri = "mongodb+srv://<USERNAME>:<PASSWORD>@<CLUSTER_NAME>.mongodb.net/?retryWrites=true&w=majority"
    
    connection_string = os.getenv("MONGO_CONNECTION_STRING", default_atlas_uri)
    ...
    try:
        ...
        # 4. Ensure spatial index is built on 2dsphere fields
        try:
